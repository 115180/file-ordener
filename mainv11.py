...
def type_time_sorting():
    ...
    if request.method == "POST":
        ...
        print(f"timeSorting: {request.form.get('timeSorting')}")
...
def sort_mod_time(map, sortByYear, sortByMonth, sortByDay): 
    os.chdir(map)
...
def my_form():
    ...
    if sortByExtension:
        ...
        if sortByDay != False or sortByMonth != False or sortByYear != False:
            currentMap, mapExists, message = get_check_map()
            ...
            if currentMap != None and mapExists == True: 
                actionCheckChoice = check_choice_map()
                print(f"action: {actionCheckChoice}")
                if actionCheckChoice == True:
                    message = sort_mod_time(currentMap, sortByYear, sortByMonth, sortByDay)
                elif actionCheckChoice == False:
                    message = "Vul een nieuwe map in"
